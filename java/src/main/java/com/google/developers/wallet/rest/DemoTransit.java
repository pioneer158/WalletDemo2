...
public class DemoTransit {
    ...
    public String createClass(String issuerId, String classSuffix) throws IOException {
        ...
        // https://developers.google.com/wallet/tickets/transit-passes/qr-code/resources/template?hl=zh-cn
        TransitClass newClass =
                new TransitClass()
                        .setId(String.format("%s.%s", issuerId, classSuffix))
                        .setLocalizedIssuerName(Common.INSTANCE.getLocalizedString("National Tail"))
        ...
        TransitObject newObject =
                new TransitObject()
                        ...
                        .setBarcode(new Barcode()
                                .setType("QR_CODE")
                                .setValue("https://hk.trip.com/?locale=zh-hk")
                                .setAlternateText("CPEF26FFFL3"))
                        /*往返类型*/
                        .setTripType("ONE_WAY")
                        /*自定义样式*/
                        .setTextModulesData(List.of(
                                new TextModuleData().setId("myfield1").setHeader("TICKET TYPE").setBody("Anytime\nDay Single"),
                                new TextModuleData().setId("myfield2").setHeader("VALID FROM").setBody("30 Aug\n2023"),
                                new TextModuleData().setId("myfield3").setHeader("ROUTE").setBody("PERMITTED"),
                                new TextModuleData().setId("myfield4").setHeader("ADULT").setBody("-"),
                                new TextModuleData().setId("myfield6").setHeader("VALID UNTIL").setBody("30 Aug 2023")
                        ));
/*用限定的样式*/
//                        .setPassengerType("SINGLE_PASSENGER")
//                        .setPassengerNames("Chen")
//                        .setTicketLeg(
//                                new TicketLeg()
//                                        .setOriginStationCode("WUH")
//                                        .setOriginName(Common.INSTANCE.getLocalizedString("Wuhan"))
//                                        .setDestinationStationCode("HKT")
//                                        .setDestinationName(Common.INSTANCE.getLocalizedString("Shanghai"))
...
//                                        .setArrivalDateTime("2020-04-12T20:20:50.52Z"));
    ...
    public String updateObject(String issuerId, String objectSuffix) throws IOException {
        ...
        updatedObject.setHexBackgroundColor("#ff85f4");
