...
public class DemoFlight {
    ...
    public String createClass(String issuerId, String classSuffix) throws IOException {
        ...
        //https://developers.google.com/wallet/tickets/boarding-passes/resources/template?hl=zh-cn#java
        FlightClass newClass =
                new FlightClass()
                        ...
                        .setLocalScheduledArrivalDateTime("2023-07-03T15:30:00")
                        .setFlightHeader(
                                new FlightHeader()
                                        .setCarrier(new FlightCarrier()
                                                .setAirlineName(Common.INSTANCE.getLocalizedString("Thai AirAsia"))
                                                .setCarrierIataCode("FD")
                                                .setAirlineLogo(new Image().
                                                        setSourceUri(new ImageUri().setUri("https://pic.english.c-ctrip.com/airline_logo/2x/fd.png"))))
                                        .setFlightNumber("3005")
                        )
                        .setOrigin(new AirportInfo()
                                .setAirportIataCode("DMK")
                                .setAirportNameOverride(Common.INSTANCE.getLocalizedString("Don Mueang"))
                                .setTerminal("T2").setGate("84"))
                        .setDestination(
                                new AirportInfo()
                                        .setAirportIataCode("HKT")
                                        .setAirportNameOverride(Common.INSTANCE.getLocalizedString("Phuket"))
                                        .setTerminal("T1").setGate("-"))
...
//                                        .setBody("Some info 5xxxfdsfdsfdsdfsfd")
//                                        .setId("myfield6"));
//                            }
//                        }))
//                        .setClassTemplateInfo((new ClassTemplateInfo())
//                                .setCardTemplateOverride((new CardTemplateOverride())
//                                        .setCardRowTemplateInfos(new ArrayList<>() {
//                                            {
...
//                                        })));
    ...
    public String updateClass(String issuerId, String classSuffix) throws IOException {
        ...
        updatedClass.setTextModulesData((new ArrayList<>() {
            {
                add((new TextModuleData()).setHeader("Label 1")
                        .setBody("Some info 1")
                        .setId("myfield1"));
    ...
    public String updateObject(String issuerId, String objectSuffix) throws IOException {
        ...
        updatedObject.setTextModulesData((new ArrayList<>() {
            {
                add((new TextModuleData()).setHeader("Label 1")
                        .setBody("Some info 1")
                        .setId("myfield1"));
